  ...
  >
    ...
    >
      ...
      <v-data-table
        ...
        :search="search"
        sort-by="eventDate"
        class="elevation-1 entities-data-table"
      >
        <!-- Headers -->
        <template v-slot:top>
          <v-toolbar flat>
        ...
        <template v-slot:no-data>
          Sem animals de acordo com os critérios escolhidos
        </template>
      </v-data-table>
    </base-material-card>
  </v-container>
...
<script>
  ...
  export default {
    ...
    computed: {
      animals: {
        ...
        get: function () {
          ...
          const storedAnimals = this.$store.getters["animal/getAnimals"]
    ...
    watch: {
      ...
      animals(val) {
        console.log('animals is ', val); //eslint-disable-line
      }
    },
    methods: {
      editItem (item) {

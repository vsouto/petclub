    ...
    >
      ...
      >
        ...
        <template v-slot:no-data>
          Sem clients de acordo com os critérios escolhidos
        </template>
      </v-data-table>
    </base-material-card>
  </v-container>
...
<script>
  ...
  export default {
    ...
    computed: {
      clients: {
        ...
        get: function () {
          ...
          const storedClients = this.$store.getters["client/getClients"]
    ...
    watch: {
      ...
      clients(val) {
        console.log('clients is ', val); //eslint-disable-line
      }
    },
    methods: {
      goToCreate() {
